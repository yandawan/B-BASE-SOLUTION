...
public class RocketMQController {
    ...
    private static final QinyiMessage RocketMQMessage = new QinyiMessage(1, "Qinyi-Study-RocketMQ-In-SpringBoot");
    ...
    public void sendMessageWithTag() {
        rocketMQProducer.sendMessageWithTag("qinyi", JSON.toJSONString(RocketMQMessage));
    }

    @GetMapping("/message-with-all")
    public void sendMessageWithAll() {
        rocketMQProducer.sendMessageWithAll("Qinyi", "qinyi", JSON.toJSONString(RocketMQMessage));
    }
}
